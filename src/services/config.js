export class ConfigService {
  ...
  loadConfig() {
    ...
    this.set(
      'MAX_FILES_TO_REVIEW',
      parseInt(process.env.MAX_FILES_TO_REVIEW) || 50
    );
  ...
  validate() {
    ...
    if (
      ...
      console.warn(
        'Warning: GitHub token may not be in the expected format (should start with ghp_ or github_pat_)'
      );
    }
  }
